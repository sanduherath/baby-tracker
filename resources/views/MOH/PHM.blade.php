...
<html lang="en">
  <head>
    ...
    <title>MOH PHM Management | Baby Tracking System</title>
    <link
  ...
  <body>
    ...
    <div class="mobile-header d-lg-none">
      ...
      <h5 class="mb-0">PHM Management</h5>
    </div>
    ...
    <div class="sidebar" id="sidebar">
      <div class="d-flex flex-column p-3 text-white" style="height: 100%">
        ...
        <ul class="nav nav-pills flex-column mb-auto">
          ...
          <li>
            <a href="PHM.html" class="nav-link active">
    ...
    <div class="main-content" id="mainContent">
      <div class="container-fluid">
        ...
        >
          <h1 class="h2">Public Health Midwife Management</h1>
          <div class="btn-toolbar mb-2 mb-md-0">
            <div class="btn-group me-2">
              <button type="button" class="btn btn-sm btn-primary">
                <i class="fas fa-file-export"></i> Export PHM Report
              </button>
          ...
          <div class="col-6 col-md-3 mb-3">
            <div class="card dashboard-card">
              <div class="card-body">
                ...
                <h5 class="card-title">Total Midwives</h5>
                <h2 class="mb-0">24</h2>
          ...
          <div class="col-6 col-md-3 mb-3">
            <div class="card dashboard-card">
              <div class="card-body">
                ...
                <h2 class="mb-0">1,824</h2>
                <p class="text-muted mb-0">
                  <span class="text-success"
                    ><i class="fas fa-arrow-up"></i> 5.1%</span
                  >
                  this month
                </p>
              </div>
          ...
          <div class="col-6 col-md-3 mb-3">
            <div class="card dashboard-card">
              <div class="card-body">
                ...
                <h5 class="card-title">Vaccination Rate</h5>
                <h2 class="mb-0">88%</h2>
                <p class="text-muted mb-0">
                  <span class="text-success"
          ...
          <div class="col-6 col-md-3 mb-3">
            <div class="card dashboard-card">
              <div class="card-body">
                ...
                <h5 class="card-title">Performance Alerts</h5>
                <h2 class="mb-0">3</h2>
                <p class="text-muted mb-0">
        ...
        <!-- PHM Performance Chart and Midwife List -->
        <div class="row mb-4">
          <div class="col-lg-6 mb-4">
            <div class="chart-container">
              <h5 class="mb-3">Midwife Performance Overview</h5>
              <canvas id="performanceChart" height="300"></canvas>
            </div>
          </div>
          <div class="col-lg-6 mb-4">
            <div class="chart-container">
              <h5 class="mb-3">Midwife Workload Distribution</h5>
              <canvas id="workloadChart" height="300"></canvas>
            </div>
          </div>
        </div>

        <!-- Midwife Management Table -->
        <div class="row">
          <div class="col-lg-12 mb-4">
            <div class="chart-container">
              ...
              >
                <h5 class="mb-0">Midwife Management</h5>
                <div>
                  <input
                    type="text"
        ...
        <!-- Quick Actions and Recent PHM Activities -->
        <div class="row">
          ...
          <div class="col-lg-8 mb-4">
            <div class="chart-container">
              <div
                class="d-flex justify-content-between align-items-center mb-3"
              >
                <h5 class="mb-0">Recent PHM Activities</h5>
              ...
              <div class="activity-list">
                <div class="activity-item">
                  ...
                  <div class="activity-content">
                    <strong>New midwife assigned</strong> - K. Wijesinghe to
                    Colombo 08
                    <div>By MOH Admin</div>
                  </div>
                </div>
                <div class="activity-item">
                  <div class="activity-icon">
                  ...
                  <div class="activity-content">
                    <strong>Performance review completed</strong> - S. Fernando
                    (MW-002)
                    <div>By MOH Admin</div>
                  </div>
                </div>
                <div class="activity-item">
                  ...
                  <div class="activity-content">
                    <strong>Performance alert issued</strong> - R. Silva (MW-003)
                    for low vaccination rate
                    <div>By MOH Admin</div>
                  </div>
                </div>
                <div class="activity-item">
                  ...
                  <div class="activity-content">
                    <strong>Area reassigned</strong> - L. Bandara (MW-004) to
                    Colombo 10
                    <div>By MOH Admin</div>
                  </div>
                </div>
    ...
    <script>
      ...
      const performanceChart = new Chart(performanceCtx, {
        type: "bar",
        data: {
          labels: ["N. Perera", "S. Fernando", "R. Silva", "L. Bandara"],
          datasets: [
            {
      ...
      // Midwife Workload Distribution Chart
      const workloadCtx = document
